...
[![Github Actions](https://img.shields.io/github/workflow/status/wujingquan/nest-file-fastify/Build?style=flat-square)](https://github.com/Blazity/nest-file-fastify)
[![NPM](https://img.shields.io/npm/v/@wujingquan/nest-file-fastify.svg?style=flat-square)](https://www.npmjs.com/package/@wujingquan/nest-file-fastify)
[![NPM](https://img.shields.io/npm/dm/@wujingquan/nest-file-fastify?style=flat-square)](https://www.npmjs.com/package/@wujingquan/nest-file-fastify)
...
```bash
$ npm install @wujingquan/nest-file-fastify @fastify/multipart
```

Yarn

```bash
$ yarn add @wujingquan/nest-file-fastify @fastify/multipart
```
